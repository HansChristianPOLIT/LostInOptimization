...
def obj_bellman(c,p,m,v_plus,par):
    """ Evaluate the Bellman equation. """
    
    # a. end-of-period assets
    a = m-c # transition equation
    ...
    # c. total value
    value_of_choice = utility.utility(c,par) + w
    
    return -value_of_choice # equivalent to maximizing 

# b. solve the Bellman equation 
@njit(parallel=True)
